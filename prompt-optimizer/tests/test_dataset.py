...
from prompt_optimizer.dataset import DatasetError, build_evalstate_pool, build_feedback_pool, load_taxonomy
...
class DatasetTest(unittest.TestCase):
    ...
    def test_build_evalstate_pool_uses_expected_topics_and_saved_context(self) -> None:
        ...
        self.assertEqual(pool.rows[0].ds4.topics_of_interest, ("acp", "gateway"))
        self.assertEqual(pool.rows[0].ds4.target, "openclaw/openclaw github_pr #1: Gateway ACP work")
        self.assertEqual(pool.rows[0].ds4.url, "https://github.com/openclaw/openclaw/pull/1")
        self.assertIn("GitHub item:", pool.rows[0].ds4.github_context or "")
