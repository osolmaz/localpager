...
Use `topics_of_interest` only for concrete topics that appear in the target. Use
an empty array for routine churn, vague context, spam, duplicates, or items that
cannot be judged.
